...
function Conversas(){
    this.aftermsg=(id,content_id)=>{
        ...
        newmsg.open("GET","https://discord.berrytern.com.br:8082/conversa/"+id+`/${biggestnum}/n`)
        ...
        document.querySelector('.message-content').addEventListener('mousewheel',(event)=>{
            if(document.querySelector('.option-selected').id==content_id){
                ...
                if ('wheelDelta' in event) {
                    ...
                    load.open("GET","https://discord.berrytern.com.br:8082/conversa/"+`${id}/${before}/${next[1]}`)
    ...
    this.get=()=>{request= new XMLHttpRequest
        ...
        request.open("GET",'https://discord.berrytern.com.br:8082/conversas')
    ...
    this.content=(id, conversa,group)=>{
        ...
        getmsg.open('GET','https://discord.berrytern.com.br:8082/conversa/'+id+'/n/n')
        ...
        message.addEventListener('keydown', (e)=>{
            if(e.key=="Enter"){
                ...
                sendm.open('POST', `https://discord.berrytern.com.br:8082/message/${id}`)
...
function change_status(status){
    ...
    request.open('POST',"https://discord.berrytern.com.br:8082/status")
    request.setRequestHeader('Authorization', "Bearer " + user.token)
            ...
            if(!!password){
                if(password.indexOf(' ')==-1){
                    if(username !=user.username){
                        ...
                        u_change.open('POST',"https://discord.berrytern.com.br:8082/change/username")
                    ...
                    if((user.icon)!=document.querySelector('img.fileimg').src.split(',')[1] && !!document.querySelector('img.fileimg').src){
                        ...
                        i_change.open('POST',"https://discord.berrytern.com.br:8082/change/icon",true)
                        ...
                        if(!!new_password){
                            if(new_password.indexOf(' ')==-1){
                                if(password==new_password){aviso(document.querySelector('.user-content'),'Senha antiga e nova são idênticas','red',4000)
                                    ...
                                    p_change.open('POST',"https://discord.berrytern.com.br:8082/change/password")
...
function logout(){
    request = new XMLHttpRequest
    request.open('POST',"https://discord.berrytern.com.br:8082/logout")
    request.setRequestHeader('Authorization', "Bearer " + user.token)
    request.setRequestHeader('Content-Type','application/json')
    request.send()
    request.onload =()=>{
...
function Friends(){
    ...
    this.able=()=>{
        ...
        request.open("POST", "https://discord.berrytern.com.br:8082/friends")
        request.setRequestHeader('Authorization',"Bearer "+ user.token)
        request.send()
        request.onload= ()=>{
                        ...
                        if(resp.list[friend].status!="offline"){
                            ...
                            opt.onclick=(event,e)=>{
                                ...
                                exc.onclick = ()=>{
                                    ...
                                    excluir.open("POST", "https://discord.berrytern.com.br:8082/friend/delete")
            ...
            if(resp.exist){
                ...
                for(let friend in resp.list){
                    ...
                    msg.onclick =()=>{
                        ...
                        find.open('POST','https://discord.berrytern.com.br:8082/conversa/new')
    ...
    this.add=()=>{
        ...
        btn.onclick=()=>{
            ...
            pedid.open('POST','https://discord.berrytern.com.br:8082/pedido/new')
        ...
        /*let request = new XMLHttpRequest
        request.open("POST", "http://discord.berrytern.com.br:8082"+"/friend/new")
        request.setRequestHeader('Authorization',"Bearer "+ user.token)
        request.send()
        request.onload= ()=>{
            let resp = JSON.parse(request.responseText)
    ...
    this.pedidos = ()=>{
        ...
        let request = new XMLHttpRequest
        request.open("POST", "https://discord.berrytern.com.br:8082"+"/pedidos")
        request.setRequestHeader('Authorization',"Bearer "+ user.token)
        request.send()
        request.onload= ()=>{
            let resp = JSON.parse(request.responseText)
            ...
            if(resp.exist){
                ...
                for(let friend in resp.list){
                    ...
                    acc.onclick =()=>{
                        ...
                        aceitar.open("POST", "https://discord.berrytern.com.br:8082/friend/new")
                    ...
                    exc.onclick=(event,e)=>{
                        ...
                        console.log('exc')
                        let excluir = new XMLHttpRequest
                        excluir.open("POST", "https://discord.berrytern.com.br:8082/pedido/delete")
                        excluir.setRequestHeader('Authorization',"Bearer "+ user.token)
                        excluir.setRequestHeader('Content-Type','application/json')
                        excluir.send(`{"to":"${resp.list[friend].id}"}`)
                        excluir.onload= ()=>{
    ...
    let request = new XMLHttpRequest
    request.open("GET", "https://discord.berrytern.com.br:8082"+"/bloqueados")
    request.setRequestHeader('Authorization',"Bearer "+ user.token)
    request.send()
    request.onload= ()=>{
        if(request.status ==404){
            ...
            if(resp.exist){
                ...
                for(let bloq in resp.list){
                    ...
                    exc.onclick=(event,e)=>{
                        ...
                        console.log('exc')
                        let excluir = new XMLHttpRequest
                        excluir.open("DELETE", "https://discord.berrytern.com.br:8082/bloqueado/delete")
                        excluir.setRequestHeader('Authorization',"Bearer "+ user.token)
                        excluir.setRequestHeader('Content-Type','application/json')
